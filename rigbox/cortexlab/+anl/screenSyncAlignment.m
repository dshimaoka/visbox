...
s.toPDTimeFrameLag = toPDTimeFrameLag;
...
% if isfield(block.trial, 'trialStartedTime')
%   s.trialOnTimes = follows(...
%     toPDTimeFrameLag([block.trial.trialStartedTime]), pdFlipTimes);
% end
% 
% if isfield(block.trial, 'trialEndedTime')
%   s.trialOffTimes = follows(...
%     toPDTimeFrameLag([block.trial.trialEndedTime]), pdFlipTimes);
% end
