...
% TODO: delete manualStartKey functionality??
...
quitKey = KbName('esc');
% manualStartKey = KbName('t'); %12/5/20 disabled
% livePlotKey = KbName('p'); %12/5/20 disabled
...
%                     [newExpRef, expSeq] = newExp(mouseName, now, expParams); %16/7/19
