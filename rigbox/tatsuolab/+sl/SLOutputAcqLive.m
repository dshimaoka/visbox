classdef SLOutputAcqLive < hw.TLOutput
    %HW.SLOUTPUTACQLIVE A digital signal that goes up when the recording starts,
    % down when it ends.
    ...
    %
    %
    % 17/7/2019 DS created from Rigbox/+hw/TLOutputAcqLive.m
    ...
    methods
        function obj = SLOutputAcqLive(hw)
