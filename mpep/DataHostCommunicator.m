classdef DataHostCommunicator < handle
    ...
    properties(GetAccess = private)
        ...
        timeout = 30*1000;%60*1000; %27/3/20
        bips;
    end
    ...
    methods
        ...
        function startExperiment(self, animal, series, experimentNumber)
            ...
            %%seriesAsNum = str2num(datestr(datenum(series, 'yyyy-mm-dd'),'yyyymmdd')); %28/3/20
            self.series = seriesAsNum(series);  %should comment out this??
            self.blockCount = 0;
        ...
        function stimStartTest(self, animal, series, experimentNumber, n, blockNumber, duration)
            ...
            self.stimNum = n;
            str = sprintf('StimStart %s %d %d %d %d %d', animal, seriesAsNum(series), ...
        ...
        function stimEndTest(self, animal, series, experimentNumber, n, blockNumber)
            %%seriesAsNum = str2num(datestr(datenum(series, 'yyyy-mm-dd'), 'yyyymmdd'));
            self.stimNum = n;
            str = sprintf('StimEnd %s %d %d %d %d', animal, seriesAsNum(series), ...
